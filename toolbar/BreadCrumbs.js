/**
 * @class
 * @author Kirill Bogdanenko <elvenfighter@myopera.com>
 *
 * This is extensible toolbar, which acts like "breadcrumbs" navigation panel.
 * Each item is turned into a breadcrumb
 *
 * Default action for each crumb is to remove it's trail, but feel free to override
 * 'handler' of each crumb (but don't forget co call .removeTrail(), if needed)
 */
